    ...
    socket.emit('admin_list_message_by_user', params, (messages) => {
        ...
        messages.forEach(message => {
            ...
            if(message.admin_id === null) {
                ...
                createDiv.innerHTML += `<span className="admin_date">${dayjs(message.created_at).format('DD/MM/YYYY HH:mm:ss')}</span>`;
...
function sendMessage(id) {
    ...
    createDiv.innerHTML += `<span className="admin_date">${dayjs().format('DD/MM/YYYY HH:mm:ss')}</span>`;
...
socket.on('admin_receive_message', data => {
    ...
    createDiv.innerHTML += `<span className="admin_date">${dayjs(data.message.created_at).format('DD/MM/YYYY HH:mm:ss')}</span>`;
